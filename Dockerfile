...
ARG NPM_CONFIG_REGISTRY
ARG VITE_UI_V2_ROLLOUT_MODE=preview
ARG VITE_UI_V2_ROLLOUT_PERCENT=0
ARG VITE_PUBLIC_UI_V2_ROLLOUT_MODE=preview
ARG VITE_PUBLIC_UI_V2_ROLLOUT_PERCENT=0

ENV VITE_UI_V2_ROLLOUT_MODE=${VITE_UI_V2_ROLLOUT_MODE}
ENV VITE_UI_V2_ROLLOUT_PERCENT=${VITE_UI_V2_ROLLOUT_PERCENT}
ENV VITE_PUBLIC_UI_V2_ROLLOUT_MODE=${VITE_PUBLIC_UI_V2_ROLLOUT_MODE}
ENV VITE_PUBLIC_UI_V2_ROLLOUT_PERCENT=${VITE_PUBLIC_UI_V2_ROLLOUT_PERCENT}
...
# Build the binaries (BuildType=release for CI builds, embed frontend)
