...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	antigravityGatewayService := service.NewAntigravityGatewayService(accountRepository, gatewayCache, schedulerSnapshotService, antigravityTokenProvider, rateLimitService, httpUpstream, settingService, tlsFingerprintProfileService, internal500CounterCache)
