...
type APIKey struct {
	...
	// Source of the API key, e.g. user or web_chat
	Source string `json:"source,omitempty"`
	// Whether this key is system-managed and hidden from normal user key lists
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldIPWhitelist, apikey.FieldIPBlacklist:
			values[i] = new([]byte)
		case apikey.FieldIsHidden:
			values[i] = new(sql.NullBool)
		case apikey.FieldQuota, apikey.FieldQuotaUsed, apikey.FieldRateLimit5h, apikey.FieldRateLimit1d, apikey.FieldRateLimit7d, apikey.FieldUsage5h, apikey.FieldUsage1d, apikey.FieldUsage7d:
			values[i] = new(sql.NullFloat64)
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldGroupID:
			values[i] = new(sql.NullInt64)
		case apikey.FieldKey, apikey.FieldName, apikey.FieldStatus, apikey.FieldSource:
