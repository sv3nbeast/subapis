...
func init() {
	...
	groupDescModelQuotaRatios := groupFields[14].Descriptor()
	...
	groupDescAllowNonStreamMessages := groupFields[39].Descriptor()
	...
	groupDescGrokChatUpstreamMode := groupFields[45].Descriptor()
	...
	groupDescGrokChatResponsesGrayPercent := groupFields[46].Descriptor()
