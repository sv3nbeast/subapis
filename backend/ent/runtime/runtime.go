...
func init() {
	...
	groupDescAllowNonStreamMessages := groupFields[33].Descriptor()
	...
	groupDescKiroCacheEmulationEnabled := groupFields[40].Descriptor()
	...
	groupDescKiroAutoStickyEnabled := groupFields[41].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[42].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[43].Descriptor()
	...
	groupDescKiroEndpointMode := groupFields[44].Descriptor()
