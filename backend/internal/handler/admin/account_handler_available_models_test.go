...
func TestAccountHandlerGetAvailableModels_AnthropicOAuthIncludesFable51(t *testing.T) {
	svc := &availableModelsAdminService{
		stubAdminService: newStubAdminService(),
		account: service.Account{
			ID:       51,
...
func TestAccountHandlerGetAvailableModels_OpenAIOAuthPassthroughFallsBackToDefaults(t *testing.T) {
	...
	require.Contains(t, ids, "gpt-5.6-sol-wm")
}
...
func TestAccountHandlerGetAvailableModels_KiroOAuthAddsNativeGPTDefault(t *testing.T) {
	svc := &availableModelsAdminService{
		...
		account: service.Account{
			...
			Credentials: map[string]any{
				"model_mapping": map[string]any{
					"custom-kiro-model": "claude-sonnet-5",
				},
			},
		},
	}
...
func TestAccountHandlerGetAvailableModels_KiroAPIKeyAddsNativeGPTDefault(t *testing.T) {
	...
	require.True(t, slices.Contains(ids, "gpt-5.6-terra"))
	require.True(t, slices.Contains(ids, "gpt-5.6-luna"))
	require.True(t, slices.Contains(ids, "codex-auto-review"))
