...
func TestDefaultCodexModelIDsForPlatform_DeepSeekUsesDeepSeekModels(t *testing.T) {
	// 本地顺序：deepseek-flash 为官方现行 Flash ID，deepseek-v4-flash 退役兼容保留在末位。
	require.Equal(t, []string{"deepseek-v4-pro", "deepseek-flash", "deepseek-v4-flash"}, defaultCodexModelIDsForPlatform(service.PlatformDeepseek))
