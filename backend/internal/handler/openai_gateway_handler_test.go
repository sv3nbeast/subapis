...
func TestOpenAIResponsesWebSocket_PassthroughKeepsTurnMappingSnapshot(t *testing.T) {
	...
	// gpt-5.6-sol 官方现行价：输入 $4/MTok、输出 $20/MTok → 2*4e-6 + 1*2e-5 = 2.8e-5
	...
	// sol 2.8e-5 / terra 1.6e-5 = 1.75（Sol 2026-08 降价后的比值）
...
func (s *openAIWSUsageHandlerChannelRepoStub) GetGroupsInOtherChannels(context.Context, int64, []int64) ([]int64, error) {
	return nil, nil
}
