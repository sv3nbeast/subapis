...
// ProvideGatewayHandler wires cross-gateway billing and the unified security audit
// without changing NewGatewayHandler's compatibility-sensitive constructor.
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, geminiCompatService, antigravityGatewayService,
		userService, concurrencyService, billingCacheService, usageService, apiKeyService,
		usageRecordWorkerPool, errorPassthroughService, contentModerationService,
		userMsgQueueService, cfg, settingService)
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, kiroBridgeService, concurrencyService,
...
func ProvideAdminHandlers(
	...
	droidOAuthHandler *admin.DroidOAuthHandler,
	...
	statusProbeSettingsHandler *admin.StatusProbeSettingsHandler,
	...
	return &AdminHandlers{
		...
		StatusProbeSettings:    statusProbeSettingsHandler,
...
func ProvideHandlers(
	...
	return &Handlers{
		...
		PublicChannelMonitor: channelMonitorUserHandler,
		Admin:                adminHandlers,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewStatusProbeSettingsHandler,
