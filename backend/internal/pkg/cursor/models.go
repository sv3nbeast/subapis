...
var DefaultModels = []Model{
	...
	pickerModel("claude-fable-5-1", "Claude Fable 5.1", "fable", "fable-latest", "fable-5.1", "fable-5-1"),
	pickerModel("claude-fable-5", "Claude Fable 5", "fable-5"),
	pickerModel("muse-spark-1.3", "Muse Spark 1.3", "muse-spark", "muse"),
	pickerModel("gemini-3.8-flash", "Gemini 3.8 Flash", "gemini-flash-latest", "gemini-flash"),
	pickerModel("grok-4.5", "Cursor Grok 4.5", "cursor-grok-4.5"),
	pickerModel("gemini-3.7-flash", "Gemini 3.7 Flash"),
