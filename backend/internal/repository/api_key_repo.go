	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldModelQuotaRatios,
				group.FieldModelQuotaGroups,
				...
				group.FieldAllowNonStreamMessages,
				...
				group.FieldKiroCacheEmulationMode,
				group.FieldKiroCacheCreationEmulationRatio,
				group.FieldKiroCacheReadEmulationRatio,
				group.FieldKiroEndpointMode,
				group.FieldKiroAnthropicFallbackEnabled,
				group.FieldKiroAnthropicFallbackFirstSemanticTimeoutSeconds,
				group.FieldKiroAnthropicFallbackMaxAnthropicAttempts,
				group.FieldGrokChatUpstreamMode,
				group.FieldGrokChatResponsesGrayPercent,
				group.FieldRpmLimit,
...
func userEntityToService(u *dbent.User) *service.User {
	...
	// Parse extra emails JSON (supports both legacy []string and structured entries)
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		AllowNonStreamMessages:          g.AllowNonStreamMessages,
		...
		GrokChatUpstreamMode:            g.GrokChatUpstreamMode,
		GrokChatResponsesGrayPercent:    g.GrokChatResponsesGrayPercent,
		...
		KiroAnthropicFallbackEnabled:    g.KiroAnthropicFallbackEnabled,
		KiroAnthropicFallbackFirstSemanticTimeoutSeconds: g.KiroAnthropicFallbackFirstSemanticTimeoutSeconds,
		KiroAnthropicFallbackMaxAnthropicAttempts:        g.KiroAnthropicFallbackMaxAnthropicAttempts,
		RPMLimit:                    g.RpmLimit,
