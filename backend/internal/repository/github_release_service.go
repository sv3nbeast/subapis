...
func isGitHubAPIURL(target *url.URL) bool {
	return target != nil && strings.EqualFold(target.Scheme, "https") && target.User == nil &&
		strings.EqualFold(target.Host, "api.github.com")
}
...
func (c *githubReleaseClient) newAPIRequest(ctx context.Context, target string) (*http.Request, error) {
