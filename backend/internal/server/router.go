...
func registerRoutes(
	...
	r.GET("/api/status/models/:model", h.Status.GetModelStatus)
	r.GET("/api/system/status", h.Status.GetStatus)
	r.GET("/api/system/status/models/:model", h.Status.GetModelStatus)
