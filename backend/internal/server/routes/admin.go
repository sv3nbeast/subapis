...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/anthropic-stable-identity", h.Admin.Account.GetAnthropicStableIdentity)
		accounts.PUT("/:id/anthropic-stable-identity", h.Admin.Account.ConfigureAnthropicStableIdentity)
		accounts.POST("/:id/anthropic-stable-identity/pause", h.Admin.Account.PauseAnthropicStableIdentity)
		accounts.POST("/:id/anthropic-stable-identity/resume", h.Admin.Account.ResumeAnthropicStableIdentity)
		accounts.DELETE("/:id/anthropic-stable-identity", h.Admin.Account.DisableAnthropicStableIdentity)
...
func registerGrokOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	grok := admin.Group("/grok")
	{
		...
		grok.POST("/oauth/device/poll", h.Admin.GrokOAuth.PollDeviceAuthorization)
		grok.POST("/oauth/device/create-account", h.Admin.GrokOAuth.CompleteDeviceAccount)
		...
		grok.POST("/accounts/:id/device-reauthorize", h.Admin.GrokOAuth.CompleteDeviceReauthorization)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/web-chat-models", h.WebChat.AdminGetModelCatalog)
		adminSettings.PUT("/web-chat-models", h.WebChat.AdminSaveModelCatalog)
		adminSettings.POST("/web-chat-models/validate", h.WebChat.AdminValidateModelCatalog)
...
func registerChannelMonitorRoutes(admin *gin.RouterGroup, h *handler.Handlers, settingService *service.SettingService) {
	...
	monitors.Use(channelMonitorAdminFeatureGuard(settingService))
	{
	...
	templates.Use(channelMonitorAdminFeatureGuard(settingService))
	{
