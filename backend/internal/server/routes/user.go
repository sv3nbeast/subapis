...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		webChat := authenticated.Group("/web-chat")
		{
			...
			webChat.GET("/artifact-storage", h.WebChat.ArtifactStorageUsage)
			webChat.GET("/artifacts/:artifact_id", h.WebChat.GetArtifact)
			webChat.DELETE("/artifacts/:artifact_id", h.WebChat.DeleteArtifact)
			...
			webChat.POST("/projects", h.WebChat.CreateProject)
			webChat.GET("/projects/:id/documents", h.WebChat.ListProjectDocuments)
			webChat.POST("/projects/:id/documents", h.WebChat.UploadProjectDocument)
			webChat.PATCH("/projects/:id", h.WebChat.UpdateProject)
			webChat.DELETE("/projects/:id", h.WebChat.DeleteProject)
			webChat.GET("/templates", h.WebChat.ListTemplates)
			webChat.POST("/templates", h.WebChat.CreateTemplate)
			webChat.PATCH("/templates/:id", h.WebChat.UpdateTemplate)
			...
			webChat.GET("/documents/:id", h.WebChat.GetDocument)
			webChat.PATCH("/documents/:id", h.WebChat.PatchDocument)
			webChat.DELETE("/documents/:id", h.WebChat.DeleteDocument)
			webChat.GET("/documents/:id/download", h.WebChat.DownloadDocument)
			webChat.POST("/sessions/:id/messages/:message_id/regenerate", h.WebChat.RegenerateMessage)
			webChat.POST("/sessions/:id/messages/:message_id/revise", h.WebChat.ReviseMessage)
			webChat.GET("/sessions/:id/messages/:message_id/versions", h.WebChat.ListMessageVersions)
			webChat.POST("/sessions/:id/messages/:message_id/activate", h.WebChat.ActivateMessageVersion)
