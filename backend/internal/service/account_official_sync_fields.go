...
// ValidateGrokMediaEligibilityExtra validates the optional media-routing override.
// A null value removes the override and restores provider-observation based routing.
