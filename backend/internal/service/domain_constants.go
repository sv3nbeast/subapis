...
const (
	...
	SettingKeyRegistrationEmailSuffixBlacklist = "registration_email_suffix_blacklist" // 注册邮箱后缀黑名单（JSON 数组）
	...
	SettingKeyStepUpEnabled          = "step_up_enabled"           // 敏感操作要求 step-up 2FA，默认关闭
	SettingKeyPanelRateLimitSettings = "panel_rate_limit_settings" // 面板 API 限流设置（JSON）
