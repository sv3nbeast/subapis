...
// prepareOpenAIWSHTTPBridgeBodyWithPreviousResponseID is retained for the
// Kiro/Claude Responses bridge, whose resume path may need to keep the client
// supplied previous_response_id. OpenAI/Grok use the account-aware helper above.
