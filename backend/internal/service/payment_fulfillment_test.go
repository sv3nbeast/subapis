...
func (r *paymentFulfillmentAffiliateRepoStub) AccrueQuota(_ context.Context, inviterID, inviteeUserID int64, amount, _ float64, freezeHours int, sourceOrderID *int64) (bool, error) {
