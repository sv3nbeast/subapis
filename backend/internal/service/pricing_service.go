...
var (
	...
	openAIGPT55FallbackPricing = &LiteLLMModelPricing{
		...
		InputCostPerTokenPriority:       10e-06, // $10 per MTok
...
func (s *PricingService) matchByModelFamily(model string) *LiteLLMModelPricing {
	...
	families := []modelFamily{
		...
		// Opus 5.5 必须排在 Opus 5 之前：claude-opus-5-5 也包含 "claude-opus-5"，
		// 顺序颠倒会让 5.5 落到 Opus 5 的 $5/$25 价卡（官方为 $4/$20）。
...
// 5. gpt-5.5* -> 官方 Codex token rate 对齐的静态兜底价
// 6. gpt-5.4* -> 业务静态兜底价
