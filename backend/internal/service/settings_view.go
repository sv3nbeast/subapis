...
type SystemSettings struct {
	...
	EnableCCHSigning                              bool   // 已废弃 no-op：直连 Anthropic OAuth 自动签署 CCH
...
//   - claude-sonnet-5、claude-opus-5 与 claude-fable-5-1 支持 1M 上下文。
...
// 默认不改写 service_tier，只有管理员显式配置规则时才 filter/block。
