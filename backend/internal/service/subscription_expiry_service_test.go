...
func (r *subscriptionExpiryRepoStub) SetQuotaCycle(context.Context, int64, time.Time, time.Time, int) error {
	return nil
}
...
func (r *subscriptionExpiryRepoStub) ResetUsageForQuotaCycle(context.Context, int64, time.Time, time.Time, time.Time, int) error {
	return nil
}
