-- Fixes the custom menu item created by migration 109:
-- updates the label from hardcoded English "Purchase" to "充值/订阅",
-- and sets the icon_svg to a credit-card SVG matching the sidebar icon.
--
