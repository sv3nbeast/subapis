<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <SearchInput
      ...
      :placeholder="t('admin.accounts.searchAvailabilityModel')"
      class="w-full sm:w-64"
...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'kiro', label: 'Kiro' }, { value: 'droid', label: 'Droid' }, { value: 'grok', label: 'Grok' }])
