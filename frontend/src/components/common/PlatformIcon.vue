<template>
  <!-- Brand assets with their original multi-color treatment. Keeping these as
       public assets avoids reducing the Gemini and Antigravity marks to a
       misleading monochrome approximation. -->
  <img
    v-if="brandAsset"
    :src="brandAsset"
    :class="[sizeClass, 'platform-brand-asset']"
    alt=""
    aria-hidden="true"
  />
  <!-- Claude/Anthropic logo -->
  <svg v-else-if="platform === 'anthropic' || platform === 'kiro'" :class="sizeClass" viewBox="0 0 16 16" fill="currentColor">
    <path
  ...
  <!-- Gemini and Antigravity are rendered by the brand asset branch above. -->
...
const brandAsset = computed(() => {
  if (props.platform === 'gemini') return '/providers/gemini.png'
  if (props.platform === 'antigravity') return '/providers/antigravity.png'
  return null
})
