<template>
  <div
    ...
    @click="handleClick"
  />
  <p v-else class="whitespace-pre-wrap break-words text-base leading-7">{{ content }}</p>
</template>
...
<style>
.web-chat-markdown { font-size: 1rem; line-height: 1.65; overflow-wrap: anywhere; }
...
.web-chat-markdown blockquote { border-left: 2px solid var(--wa-line,#d4d4d8); padding-left: .8rem; color: var(--wa-muted,#71717a); }
...
.web-chat-markdown a { color: var(--wa-accent,#2563eb); text-decoration: underline; }
