...
const openaiModels = [
  ...
  // GPT-5.6 系列
  'gpt-5.6', 'gpt-5.6-sol', 'gpt-5.6-sol-wm', 'gpt-5.6-terra', 'gpt-5.6-luna',
  // GPT-5.5 系列
  'gpt-5.5',
  // GPT-5.4 系列
...
const anthropicPresetMappings = [
  ...
  { label: 'Opus 4.8-thinking', from: 'claude-opus-4-8-thinking', to: 'claude-opus-4-8', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
...
const openaiPresetMappings = [
  { label: 'GPT-6 Astra', from: 'gpt-6-astra', to: 'gpt-6-astra', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
  ...
  { label: 'GPT-5.6 Sol WM', from: 'gpt-5.6-sol-wm', to: 'gpt-5.6-sol-wm', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
...
const antigravityPresetMappings = [
  ...
  { label: 'Opus 4.7', from: 'claude-opus-4-7', to: 'claude-opus-4-6-thinking', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
  { label: 'Opus 4.7-thinking', from: 'claude-opus-4-7-thinking', to: 'claude-opus-4-6-thinking', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
...
const bedrockPresetMappings = [
  { label: 'Opus 5', from: 'claude-opus-5', to: 'us.anthropic.claude-opus-5-v1', color: 'bg-purple-100 text-purple-700 hover:bg-purple-200 dark:bg-purple-900/30 dark:text-purple-400' },
...
// 默认映射（从后端 API 获取，与 constants.go 保持一致）
...
export async function fetchKiroDefaultMappings(): Promise<{ from: string; to: string }[]> {
  ...
  try {
    ...
    console.warn('[fetchKiroDefaultMappings] API failed, using preset fallback', e)
    _kiroDefaultMappingsCache = kiroPresetMappings.map(({ from, to }) => ({ from, to }))
  }
  return _kiroDefaultMappingsCache.map(({ from, to }) => ({ from, to }))
}
