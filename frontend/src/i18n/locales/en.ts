...
import landingMessages from './en/landing'
import commonMessages from './en/common'
import dashboardMessages from './en/dashboard'
import channelMonitorV2Messages from './en/channelMonitorV2'
import adminMessages from './en/admin'
import miscMessages from './en/misc'
...
const baseMessages = {
  ...
  setup: {
    title: 'SubAPIs Setup',
    description: 'Configure your SubAPIs instance',
    database: {
  ...
  legal: {
    ...
    loginAgreementPrompt: {
      ...
      modalCheckbox: 'I have read and agree to all terms above',
      reject: 'Reject',
  ...
  nav: {
    ...
    returnToClassic: 'Return to classic interface',
  ...
  auth: {
    ...
    dingtalk: {
      callbackTitle: 'DingTalk Sign-in Callback',
  ...
  dashboard: {
    ...
    greetingTitle: '{greeting}, {name}',
    overviewSubtitle: "Here's how your APIs are running today.",
    analysisSubtitle: 'Review tokens, costs, and models across a selected date range.',
    workspaceView: 'Dashboard view',
    overviewView: 'Overview',
    analysisView: 'Analysis',
    requestTrend: 'Request Trend',
    requestTrendDescription: 'Successful requests across all API keys',
    requestCount: 'Requests',
    dayCount: '{count} days',
    routeHealth: 'Route health',
    routeHealthDescription: 'Latest service probe results',
    successRate: 'Success rate',
    moreMetrics: 'Detailed Metrics',
    moreMetricsDescription: 'Account, token, cost, and model usage details',
    loadFailed: 'Unable to load the runtime overview',
    loadFailedDescription: 'The data request did not complete. Try loading it again.',
    balance: 'Balance',
    apiKeys: 'API Keys',
    todayRequests: 'Today Requests',
    todayCost: 'Today Cost',
    ...
    batchImageAgentDesc: 'Open the batch image workflow',
  ...
  usage: {
    ...
    imageSizeLegacyUnstandardized: 'Legacy unstandardized size',
    imageSizeSourceOutput: 'Output size',
    imageSizeSourceInput: 'Input size',
    imageSizeSourceDefault: 'Default size',
  ...
  webChat: {
    ...
    sessions: 'Sessions',
    openSessions: 'Open session list',
    openContext: 'Open context settings',
    projects: 'Projects',
    project: 'Project',
    allChats: 'All chats',
    ...
    deleteProjectConfirm: 'Delete this project? Its chats will become uncategorized.',
    templates: 'Templates',
    templateLibrary: 'Prompt template library',
    ...
    copyAsPersonal: 'Copy as personal',
    insertTemplate: 'Insert into editor',
    chooseTemplate: 'Choose a template',
    deleteTemplateConfirm: 'Delete this personal template?',
    versionOriginal: 'Original',
    versionRegenerated: 'Regenerated',
    versionEdited: 'Edited',
    newChat: 'New Chat',
    noSessions: 'No sessions yet',
    searchSessions: 'Search title, model, or group',
    pin: 'Pin or unpin',
    rename: 'Rename',
    ...
    revisePrompt: 'Edit this message and regenerate from here',
    exportMarkdown: 'Export Markdown',
    exportJson: 'Export JSON',
    advanced: 'Advanced settings',
    systemPrompt: 'System prompt',
    temperature: 'Temperature',
    temperatureDefault: 'Blank uses the model default',
  ...
  profile: {
    ...
    basicsTitle: 'Basics',
    basicsDescription: 'Manage your avatar, username, and core account details',
    linkedProfileSources: 'Profile Sources',
    linkedProfileSourcesDescription: 'The details below come from your connected sign-in providers',
    ...
    avatar: {
      title: 'Avatar',
      description: 'Upload and manage your avatar',
      uploadAction: 'Upload Image',
      uploadHint: 'Uploaded images are compressed to 20KB when possible',
      uploadRequired: 'Please select a valid avatar image first',
      invalidType: 'Please choose an image file',
      gifTooLarge: 'GIF avatars must already be 20KB or smaller',
      compressTooLarge: 'Unable to compress this image below 20KB',
      compressFailed: 'Failed to process the selected image',
    ...
    authBindings: {
      ...
      description: 'Manage the login methods available for this account',
      bindAction: 'Bind {providerName}',
      unbindAction: 'Unbind',
      bindSuccess: 'Binding completed',
      unbindSuccess: '{providerName} unbound',
      boundCount: '{count} identities bound',
    ...
    balanceNotify: {
      ...
      extraEmailsHint: 'You can add up to 3 alert emails. Unverified addresses must be verified first.',
      noExtraEmails: 'No extra notification emails',
      enterEmail: 'Enter email address',
      addEmail: 'Add Email',
      emailPlaceholder: 'Enter email address',
      emailDuplicate: 'This email is already in the notification list',
      sendCode: 'Send Code',
  ...
  admin: {
    ...
    dashboard: {
      ...
      recentUsage: 'Recent Usage',
      quickActions: 'Quick Actions',
      batchImage: 'Batch Image Agent',
      batchImageDesc: 'Open the batch image workflow',
      groupPricing: 'Group Pricing',
      groupPricingDesc: 'Configure groups, quotas, and pricing',
    ...
    users: {
      ...
      columns: {
        ...
        subscriptions: 'Subscriptions',
        balance: 'Balance',
        balancePlatformQuota: 'Platform Quota',
        usage: 'Usage',
      ...
      platformQuota: {
        ...
        clearAllConfirm: 'Are you sure you want to clear all platform quotas for this user?',
        loadFailed: 'Failed to load platform quotas',
        updateSuccess: 'Platform quotas saved',
        updateFailed: 'Failed to save platform quotas',
        invalidNumber: 'Quota must be blank or greater than or equal to 0',
        cellColumnTooltip: 'View or edit this user platform quotas',
        cellNotConfigured: 'Not configured',
        menuItem: 'Platform Quota',
        windowDaily: 'D',
        windowWeekly: 'W',
        windowMonthly: 'M',
        reset: {
    ...
    groups: {
      ...
      compositeRoutes: {
        ...
        upstreamModelHint: 'Leave empty to pass the requested model through. Prefix matches preserve each matched model; setting a value routes every match to that fixed model.',
        notes: 'Notes',
        enabled: 'Enabled',
        preview: 'Preview',
        matched: 'Matched',
    ...
    riskControl: {
      ...
      preBlockSyncHint: 'Shows real-time hit and processing status for synchronous pre-blocking.',
      ...
      keywordModeKeywordOnlyDesc: 'Use local keyword rules only without calling the moderation API.',
      keywordModeApiOnly: 'API moderation only',
      keywordModeApiOnlyDesc: 'Skip local keyword rules and call the moderation API only.',
      modelFilterAll: 'All models',
      modelFilterAllDesc: 'All model requests are included in moderation.',
      modelFilterInclude: 'Only selected models',
      modelFilterIncludeDesc: 'Only selected models are included in moderation.',
      modelFilterExclude: 'Exclude selected models',
      modelFilterExcludeDesc: 'All requests except selected models are included in moderation.',
      modelFilter: 'Model Filter',
      modelFilterHint: 'Limit which model requests enter content moderation.',
      modelFilterModels: 'Models',
      modelFilterModelsRequired: 'Select at least one model',
      modelFilterAllSummary: 'All models',
      modelFilterIncludeSummary: 'Only {count} models',
      modelFilterExcludeSummary: 'Exclude {count} models',
      modelFilterModelCount: '{count} models',
      keywordBlockingMode: 'Keyword Blocking Mode',
      keywordModeApiOnlyNotice: 'API moderation only. Local keywords are not used for blocking.',
      keywordModeKeywordOnlyNotice: 'Keyword rules only. The moderation API will not be called.',
      blockedKeywords: 'Blocked Keywords',
      blockedKeywordCount: '{count} keyword(s)',
      blockedKeywordsDescription: 'Requests matching these keywords are handled by the current policy.',
      blockedKeywordsPlaceholder: 'One keyword per line',
      blockedKeywordsPreBlockHint: 'Pre-block checks evaluate these keywords first.',
      blockedKeywordsModeWarning: 'Current mode: {mode}',
      blockedKeywordsLimit: 'Up to {max} keywords',
      riskThresholds: 'Risk Thresholds',
      riskThresholdsHint: 'Configure hit thresholds for each category.',
      riskThresholdReset: 'Reset to Defaults',
      riskThresholdPercent: 'Threshold Percent',
      riskThresholdDefault: 'Default {value}',
      preBlockActive: 'Pre-block',
      preBlockActiveHint: 'Whether pre-blocking is currently enabled.',
      preBlockChecked: 'Checked',
      preBlockCheckedHint: 'Requests that entered pre-block checks.',
      preBlockAllowed: 'Allowed',
      preBlockAllowedHint: 'Requests allowed after pre-block checks.',
      preBlockBlocked: 'Blocked',
      preBlockBlockedHint: 'Requests blocked directly by pre-block checks.',
      preBlockErrors: 'Errors',
      preBlockErrorsHint: 'Errors during pre-block checks.',
      preBlockAvgLatency: 'Avg Latency',
      preBlockAvgLatencyHint: 'Average pre-block check latency.',
      overview: {
        status: 'Status',
        enabled: 'Enabled',
        disabled: 'Disabled',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeChatCompletionsHint: 'Use the /v1/chat/completions request shape.',
        apiModeResponses: 'Responses',
        apiModeResponsesHint: 'Use the /v1/responses request shape.',
    ...
    accounts: {
      ...
      dataImportParseFailedFile: 'Failed to parse data file: {name}',
      dataImportInvalidFile: 'Invalid data file: {name}',
      ...
      openai: {
        ...
        codexCLIOnlyAllowClaudeCode: 'Allow Claude Code compatible requests',
        codexCLIOnlyAllowClaudeCodeDesc:
          'When enabled, Codex official-client restriction also allows requests that match the Claude Code compatible entry path.',
      ...
      syncUpstreamModels: 'Sync from upstream',
      syncUpstreamModelsLoading: 'Syncing...',
      syncUpstreamModelsEmpty: 'No models returned by upstream',
      syncUpstreamModelsFailed: 'Failed to sync upstream models',
      syncUpstreamModelsSuccess: 'Synced {count} new model(s) from {total} upstream model(s)',
      syncUpstreamModelsNoChanges: 'No new models. {count} upstream model(s) already exist.',
      ...
      poolModeRetryStatusCodes: 'Retry HTTP Status Codes',
      poolModeRetryStatusCodesHint:
        'Comma-separated upstream HTTP status codes to retry in pool mode. Default: {default}.',
      headerOverride: {
        title: 'Header Override',
        hint: 'Batch configure custom request headers for eligible API key accounts.',
        info: 'Overrides are sent to upstream requests after blocked headers are filtered. Use carefully.',
        bulkReplaceHint: 'Saving will replace header override rows for all selected accounts.',
        bulkDisableHint: 'Turn the switch off to disable header overrides for selected accounts.',
        namePlaceholder: 'Header name',
        valuePlaceholder: 'Header value',
        addRow: 'Add header',
        fillTemplate: 'Fill template',
        emptyValueHint: 'Empty values are allowed and will be sent as empty headers.',
        bulkEmptyRows: 'Add at least one header row, or turn off header overrides to clear.',
      ...
      oauth: {
        ...
        kiro: {
          ...
          oauthProviderTitle: 'Sign-in Provider',
          socialSubtitle: 'Use the provider shown by Kiro',
          googleTitle: 'Google',
          googleDesc: 'Sign in with Google',
          githubTitle: 'GitHub',
          githubDesc: 'Sign in with GitHub',
          startUrlLabel: 'AWS IDC Start URL',
      ...
      requestStarted: 'Started test request',
      connectedToApi: 'Started test request',
      usingModel: 'Using model: {model}',
      sendingTestMessage: 'Sending test message: "hi"',
      sendingMinimalProbeRequest: 'Sending minimal probe request: "." (max_tokens=1)',
      ...
      usageWindow: {
        ...
        grokRequests: 'Req',
        grokTokens: 'Tok',
        grokWeeklyCredits: 'Week',
        grokRequestsRate: 'Req',
        grokTokensRate: 'Tok',
        grokWeeklySummary: 'Weekly used {used}, remaining {remaining}',
        grokOnDemandSummary: 'Pay as you go {used}/{cap}, remaining {remaining}',
        grokOnDemandDisabled: 'Pay as you go disabled',
        grokPrepaidBalance: 'Prepaid balance {balance}',
        grokBillingUnknown: 'Official Grok Billing usage has not been queried.',
        grokBillingFailed: 'Official Grok Billing query failed.',
        grokBillingUpdated: 'Billing {time}',
        grokUnknown: 'Grok rate limits are unknown until upstream headers are observed.',
        grokRetryAfter: 'Retry after {time}',
        grokProbe: 'Refresh billing',
        grokProbeTooltip: 'Query the official Grok CLI Billing endpoint without sending an inference request',
        ...
        grokLastProbe: 'Rate probe {time}',
        grokLastHeadersSeen: 'Rate headers {time}',
    ...
    proxies: {
      ...
      ad: {
        inline: 'Recommended proxy service'
      },
      dataImport: 'Import',
      dataExportSelected: 'Export Selected',
    ...
    redeem: {
      ...
      expiryDaysRequired: 'Enter a valid expiry day count',
      noBatchFieldsSelected: 'Select at least one field to update',
      batchNotesPlaceholder: 'Enter notes. Leave empty to clear notes.',
      batchFields: {
        status: 'Status',
        expiresAt: 'Expires At',
        notes: 'Notes',
    ...
    ops: {
      ...
      settings: {
        ...
        validation: {
          ...
          requestErrorRateMaxRange: 'Request error rate maximum must be between 0 and 100',
          upstreamErrorRateMaxRange: 'Upstream error rate maximum must be between 0 and 100',
          openaiQuotaAutoPauseRange: 'OpenAI account quota auto-pause threshold must be between 0 and 100%'
        }
      },
      concurrency: {
    ...
    settings: {
      ...
      apiKeyUsage: {
        ...
        description: 'Manage built-in client defaults and group-matched custom templates shown in the user Use Key dialog. This configuration is public; do not include secrets.',
        ...
        groupTemplates: {
          title: 'Fixed group templates',
          description: 'Store fixed configurations for a group and choose which clients appear in Use Key. When enabled, only templates selected here are shown for that group.',
          selectGroup: 'Select a group',
          addGroup: 'Add group configuration',
          empty: 'No fixed group templates are configured. All groups continue to use built-in configurations.',
          overrideEnabled: 'This configuration controls the group Use Key display',
          overrideDisabled: 'Disabled; the built-in configuration remains active',
          templates: 'Visible templates',
          templatesHint: 'Enabled templates are displayed in sort_order order.',
          addTemplate: 'Add fixed template',
          noTemplates: 'No templates. If this group configuration is enabled, no client configuration will be shown.',
          editTemplate: 'Edit template content',
          templateJson: 'Fixed template JSON',
          variables: 'Template content supports double-brace variables such as api_key, base_url, base_url_v1, base_url_v1beta, group_id, group_name, and platform.',
          newTemplate: 'New fixed template',
          defaultVariant: 'Configuration',
          objectRequired: 'The template JSON root must be an object',
          fieldsRequired: 'The template must contain id, label, kind, and variants'
        },
        templateProfiles: {
          title: 'Advanced client template rules',
          description: 'Use for cross-platform, multi-group, and priority composition. Prefer fixed group templates for ordinary group configuration.',
          addProfile: 'Add rule',
          empty: 'No custom rules. Users continue to receive the built-in templates.',
          newProfile: 'New template rule',
          profileId: 'Rule ID',
          profileName: 'Rule name',
          mode: 'Apply mode',
          priority: 'Priority',
          platforms: 'Match platforms',
          platformsPlaceholder: 'Example: grok, anthropic; empty matches all',
          groups: 'Match groups (multiple)',
          matchHint: 'When platforms and groups are both set, both must match. Leave groups empty to match any group ID.',
          presets: 'Add preset:',
          templatesJson: 'Template JSON',
          variables: 'Variables: api_key, base_url, base_url_v1, base_url_v1beta, group_id, group_name, and platform (wrap names in double braces in JSON), plus Claude/Codex/Gemini model settings. Claude Code-only groups ultimately show only templates with kind=claude_code.',
          arrayRequired: 'Template JSON must be an array'
        },
      ...
      features: {
        ...
        webChat: {
          ...
          projectsHint: 'Let users organize chats and define default models and templates.',
          templates: 'Enable prompt templates',
          templatesHint: 'Enable system and personal templates with structured variables.',
      ...
      dingtalk: {
        title: 'DingTalk Connect',
        description: 'Configure DingTalk OAuth sign-in and corporate identity sync.',
        enable: 'Enable DingTalk Login',
        enableHint: 'Allow users to sign in with DingTalk.',
        clientId: 'Client ID / AppKey',
        clientIdPlaceholder: 'Enter DingTalk Client ID or AppKey',
        clientIdHint: 'From the DingTalk developer console application credentials.',
        clientSecret: 'Client Secret / AppSecret',
        clientSecretPlaceholder: 'Enter DingTalk Client Secret or AppSecret',
        clientSecretConfiguredPlaceholder: 'Already configured, leave empty to keep',
        clientSecretHint: 'Stored encrypted. Required for DingTalk OAuth callbacks.',
        clientSecretConfiguredHint: 'Client secret is configured. Leave empty to keep the current value.',
        redirectUrl: 'Redirect URL',
        redirectUrlPlaceholder: 'https://example.com/auth/dingtalk/callback',
        redirectUrlHint: 'Must match the callback URL configured in the DingTalk application.',
        corpPolicy: {
          label: 'Corporate Restriction',
          hint: 'Restrict sign-in to DingTalk organization users when needed.',
          none: 'No restriction',
          internalOnly: 'Internal organization users only'
        },
        bypassRegistration: 'Bypass Registration Restrictions',
        bypassRegistrationHint:
          'Allow internal DingTalk users to create or bind accounts even when normal registration gates are enabled.',
        syncDisplayName: 'Sync Display Name',
        syncDisplayNameHint: 'Write the DingTalk display name to a user attribute after login.',
        syncDisplayNameTarget: 'Attribute Key',
        syncAttrDisplayName: 'Display Label',
        syncDisplayNameTargetHint: 'The synchronized value is stored in user attributes using this key and label.',
        syncCorpEmail: 'Sync Corporate Email',
        syncCorpEmailHint: 'Write the DingTalk corporate email to a user attribute after login.',
        syncCorpEmailPermissionHint: 'Requires the DingTalk app to have permission to read corporate email.',
        syncCorpEmailTarget: 'Attribute Key',
        syncCorpEmailTargetHint: 'The synchronized corporate email is stored in user attributes using this key and label.',
        syncDept: 'Sync Department',
        syncDeptHint: 'Write the DingTalk department to a user attribute after login.',
        syncDeptPermissionHint: 'Requires the DingTalk app to have permission to read department information.',
        syncDeptTarget: 'Attribute Key',
        syncDeptTargetHint: 'The synchronized department is stored in user attributes using this key and label.'
      },
      ...
      defaults: {
        ...
        defaultPlatformQuotasHint: 'Set default daily, weekly, and monthly spending quotas by platform for new users.',
        platformQuotaNotice: 'Leave blank for unlimited. These defaults are applied only when a new user is created.'
      },
      claudeCode: {
      ...
      gatewayForwarding: {
        ...
        clientDatelineNormalizationHint:
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Map additional local payment method types to EasyPay upstream types.',
        addCustomMethod: 'Add Method',
        customMethodType: 'Local Type',
        customMethodUpstreamType: 'Upstream Type',
        customMethodDisplayName: 'Display Name',
        validationEasyPayCustomMethodRequired: 'Custom method type and upstream type are required.',
        validationEasyPayCustomMethodTypeInvalid: 'Custom method type can only contain lowercase letters, numbers, underscores, and hyphens.',
        validationEasyPayCustomMethodUpstreamTypeInvalid:
          'Upstream method type can only contain lowercase letters, numbers, underscores, and hyphens.',
        validationEasyPayCustomMethodReserved: 'This method type is already a built-in EasyPay type.',
        validationEasyPayCustomMethodPrefixReserved: 'Custom method types cannot start with alipay or wxpay.',
        validationEasyPayCustomMethodDuplicate: 'Duplicate custom method types are not allowed.',
      ...
      emailTemplates: {
        ...
        description: 'Edit system email templates and preview rendered variables.',
        preview: 'Preview',
        ...
        previewSecurityHint: 'Preview is only for layout checks. Actual sending is rendered by the backend template.',
        validationRequired: 'Subject and HTML content are required',
        saveSuccess: 'Email template saved',
        restoreConfirm: 'Restore the official template? Current custom content will be overwritten.',
  ...
  payment: {
    ...
    invoice: {
      ...
      buyerType: 'Title Type',
      individual: 'Individual',
      enterprise: 'Enterprise',
      buyerName: 'Invoice Title / Name',
      buyerNamePlaceholder: 'Use personal name for individuals, company name for enterprises',
      buyerTaxNo: 'Taxpayer ID',
    ...
    planCard: {
      ...
      bonusDailyQuota: '${amount}/day',
      bonusWeeklyQuota: '${amount}/week',
    ...
    admin: {
      ...
      price: 'Price',
      subscriptionCnyPayPreview: 'Estimated subscription payment: {amount}',
      subscriptionCnyPayPreviewWithFee: ' (fee {feeRate}%, total {total})',
      validityDays: 'Validity (days)',
      ...
      group: 'Group',
      groupId: 'Group ID',
      bonusGroups: 'Bonus Subscription Groups',
      bonusGroupsHint: 'These subscriptions are granted together with the primary group for the same validity period.',
      noBonusGroups: 'No other subscription groups are available.',
      bonusDailyQuota: '${amount}/day',
      bonusWeeklyQuota: '${amount}/week',
      bonusMonthlyQuota: '${amount}/month',
      features: 'Features',
      ...
      invoiceAutoIssueHint: 'Call the invoice provider immediately after user submission, without manual approval',
      invoiceProvider: 'Invoice Provider',
      invoiceProviderUnset: 'Not Configured',
      invoiceProviderMock: 'Mock Provider',
      invoiceProviderLexiang: 'Lexiang Invoice',
      defaultInvoiceType: 'Default Invoice Type',
      invoiceTypeDigitalNormal: 'Digital Normal Invoice',
      invoiceTypeDigitalSpecial: 'Digital Special Invoice',
      invoiceTaxRate: 'Tax Rate',
      invoiceItemName: 'Item Name',
      invoiceTaxClassificationCode: 'Tax Classification Code',
      invoiceSellerInfo: 'Seller Info',
      sellerName: 'Seller Name',
      sellerTaxNo: 'Seller Tax No.',
      sellerAddress: 'Seller Address',
      sellerPhone: 'Seller Phone',
      sellerBankName: 'Seller Bank',
      sellerBankAccount: 'Seller Bank Account',
      drawerName: 'Drawer',
      payeeName: 'Payee',
      reviewerName: 'Reviewer',
      invoiceProviderConfig: 'Provider Config',
  ...
  status: {
    ...
    outage: 'Outage',
    uptime: 'uptime',
    daysAgo: 'Last 30 days',
    hoursAgoLabel: 'Last 24 hours',
    now: 'Now',
    today: 'Today',
    probes: 'probes',
    success: 'successful',
  ...
  adminStatus: {
    ...
    noModels: 'No monitored models yet. Add at least one model.',
    viewStatusPage: 'View service status page',
