export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      preBlockAPIKeyLoadHint: 'View request distribution and latency for moderation API keys.',
      preBlockAPIKeyLoadEmpty: 'No API key load data',
      preBlockAPIKeyLoadSummary: 'Total {total}, success {success}, errors {errors}',
