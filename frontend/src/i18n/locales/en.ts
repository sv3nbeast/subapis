  ...
  admin: {
    ...
    settings: {
      ...
      apiKeyUsage: {
        ...
        templateProfiles: {
          title: 'Client template rules',
          description: 'Append or replace Use Key templates by platform, group ID, and Claude Code restriction. Platform matching accepts Grok and future platform identifiers.',
          addProfile: 'Add rule',
