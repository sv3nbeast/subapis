    ...
    accounts: {
      ...
      cnProviders: {
        accountMode: {
          title: 'Account Type',
          payg: 'Pay-as-you-go',
          paygDesc: 'Consumes account balance and is billed per token.',
          coding: 'Coding Plan',
          codingDesc: 'Subscription coding package with rolling usage windows.',
        },
        apiProtocol: {
          title: 'API Protocol',
          adaptive: 'Adaptive',
          adaptiveDesc: 'Prefer each provider-native endpoint and convert only when unavailable.',
          endpoints: 'Protocol endpoints',
          responsesFallbackDesc: 'This provider has no native Responses endpoint, so Responses requests are converted to Chat Completions.',
          chatCompletions: 'Chat Completions',
          chatCompletionsDesc: 'Use the OpenAI-compatible Chat Completions endpoint.',
          anthropic: 'Anthropic',
          anthropicDesc: 'Use the provider-native Anthropic endpoint for Claude Code.',
          responses: 'Responses',
          responsesDesc: 'Use the provider-native Responses endpoint for Codex.',
        },
        zhipuTeam: {
          title: 'Team Plan Organization / Project ID',
          organization: 'Organization ID (optional)',
          organizationPlaceholder: 'Team Coding Plan organization ID',
          project: 'Project ID (optional)',
          projectPlaceholder: 'Team Coding Plan project ID',
          hint: 'Required only for a team GLM Coding Plan; leave empty for personal plans.',
          help: {
            title: 'How to get the Organization / Project ID',
            step1: 'Open Coding Plan → Team → My Plan in the Zhipu console.',
            step2: 'Open browser DevTools, select Network, then reload the page.',
            step3: 'Filter requests by /api/biz/v1/organization and open a matching request.',
            step4: 'Copy the org-… and proj_… values from the request URL or headers.',
            example: 'Example: …/organization/org-…/projects/proj_…/api_keys',
          },
        },
        balance: 'Balance --',
        window5h: '5h',
        windowWeekly: '7d',
        probe: 'Query',
        probeTooltip: 'Query rolling provider quota usage',
        balanceProbeTooltip: 'Query the provider account balance',
      ...
      grok: {
        ...
        imagePromptHint: 'Image generation probe using the selected Grok image model.',
      ...
      anthropic: {
        ...
        stableIdentity: {
          ...
          loadFailed: 'Failed to load stable identity status',
          configureFailed: 'Failed to configure stable identity',
          disableFailed: 'Failed to disable stable identity',
        },
      },
      ...
      cursor: {
        ...
        mixedSchedulingHint: 'Enable to join Claude group scheduling, tool calls included (works with Claude Code). Requests carrying images are handed to another account in the group rather than failing.',
        ...
        authMode: {
          ...
          oauthHint: 'Sign in to Cursor and fetch credentials automatically',
          manual: 'Manual import',
          manualHint: 'Paste credentials from a local Cursor install'
        },
        oauth: {
          hint: 'Generate an authorization link below and sign in to Cursor in your browser; credentials are collected automatically. The device id is generated by the gateway and bound to this account.',
          start: 'Get authorization link',
          restart: 'Get a new authorization link',
          linkLabel: 'Authorization link',
          linkHint: 'Open it in a browser and sign in; this page detects completion automatically.',
          waiting: 'Waiting for the browser sign-in to finish…',
          authorized: 'Authorized: {email}',
          notAuthorized: 'Complete the browser authorization first',
          sessionMissing: 'Authorization session is missing, get a new link',
          timeout: 'Authorization timed out, get a new link',
          authFailed: 'Cursor authorization failed'
        }
      },
      // OAuth flow
      oauth: {
