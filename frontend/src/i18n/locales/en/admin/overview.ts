export default {
    ...
    groups: {
      ...
      modelPricing: {
        title: 'Model Pricing',
        description: 'Configure per-model token and image pricing for this group.',
        add: 'Add pricing rule',
        longContext: 'Long context pricing',
        longContextHint: 'Configure a separate price for requests above the long-context threshold.'
      },
      accountFilters: {
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit Anthropic and OpenAI reasoning effort requests. For Composite groups, it applies to the resolved target platform. Higher values are capped; omitted effort stays omitted. The ceiling takes precedence over reasoning effort mappings.',
