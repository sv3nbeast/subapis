export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        kiroOperatorInstructionsEnabled: 'Kiro Operator Instructions',
        kiroOperatorInstructionsEnabledHint: 'Append an operator instruction block to the platform preamble for Claude models on Kiro accounts. GPT and Sonnet-family models keep their existing prompt. Enabled by default.',
        kiroOperatorInstructions: 'Kiro Operator Instructions Text',
        kiroOperatorInstructionsPlaceholder: 'Leave empty to use the built-in default (Verify before asserting…).',
        kiroOperatorInstructionsHint: 'Takes effect within 60 seconds of saving. Limit 4000 characters. Run an identity and task A/B against the real upstream before changing the text.',
