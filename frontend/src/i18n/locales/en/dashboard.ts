export default {
  ...
  usage: {
    ...
    longContextBilling: 'Long-context pricing',
    longContextBillingApplied: 'Long-context pricing applied',
    longContextBillingBadge: 'Long ctx',
    longContextBillingHint: 'This request exceeded the long-context threshold, so the entire request is billed at long-context rates: input ×{input}, output ×{output}.',
    longContextBillingContext: 'Context tokens',
    ...
    exportTooLarge: 'Export exceeds the {limit}-row limit; narrow the date range or filters',
    exportInProgress: 'An export is already running; wait for it to finish before starting another',
    exportRateLimited: 'Too many requests; please try again shortly',
