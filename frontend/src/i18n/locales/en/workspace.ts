export default { workspace: {
  ...
  imageHint: 'Image mode generates a picture you can preview, download, or find under Files. To edit one, attach an image or choose Revise on a generated image, up to 2 inputs.', noImageModel: 'No image model has been configured yet.', chatHint: 'Chat produces text. Choose Slides, Spreadsheet or Document for a downloadable file.',
