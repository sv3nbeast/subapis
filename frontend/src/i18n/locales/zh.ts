...
const baseMessages = {
  ...
  docsGuide: {
    ...
    bottom: {
      eyebrow: '准备接入',
      title: '先完成测试调用，再接入生产服务',
      description: '建议先用独立 API Key 进行联调，确认模型权限、余额、限流和日志都符合预期后，再切换到生产业务。',
      button: '开始注册'
    }
  },
  ...
  auth: {
    ...
    dingtalk: {
      ...
      callbackHint: '如果页面未自动跳转，请返回登录页重试。',
      callbackMissingToken: '钉钉登录信息缺失，请返回重试。',
      invitationRequired: '该钉钉账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
      completeRegistration: '完成注册',
      completing: '正在完成注册...',
      completeRegistrationFailed: '注册失败，请检查邀请码后重试。',
      createAccountTitle: '创建钉钉登录账号',
      registrationDisabledRedirectToBind: '当前站点未开放注册，请登录已有账号后绑定钉钉。',
      signIn: '使用钉钉登录',
  ...
  dashboard: {
    ...
    overviewSubtitle: '这里是你今天的 API 运行概况。',
    analysisSubtitle: '按时间范围查看 Token、费用与模型明细。',
    workspaceView: '仪表盘视图',
    overviewView: '概览',
    analysisView: '分析',
    requestTrend: '请求趋势',
    requestTrendDescription: '跨全部密钥的成功请求',
    requestCount: '请求数',
    dayCount: '{count} 天',
    routeHealth: '路由健康',
    routeHealthDescription: '最近服务探测结果',
    successRate: '成功率',
    moreMetrics: '详细指标',
    moreMetricsDescription: '账户、Token、费用与模型使用明细',
    loadFailed: '暂时无法载入运行概况',
    loadFailedDescription: '数据请求未完成，可以重新载入。',
    balance: '余额',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
    ...
    batchImageAgent: '批量生图',
    batchImageAgentDesc: '进入批量图片任务',
    redeemCode: '兑换码',
  ...
  usage: {
    ...
    requestedModel: '请求',
    upstreamModel: '上游',
    sentUpstreamModel: '发送至上游的模型',
    upstreamResponseModel: '上游响应模型',
    upstreamModelMismatch: '上游模型不一致',
    modelMismatch: '模型不一致',
    modelVariant: '模型变体',
    ...
    imageSizeUnknown: '未知',
    imageSizeLegacyUnstandardized: '旧版未标准化尺寸',
    imageSizeSourceOutput: '输出尺寸',
    imageSizeSourceInput: '输入尺寸',
    imageSizeSourceDefault: '默认尺寸',
  ...
  availableChannels: {
    ...
    pricing: {
      ...
      cacheWrite5mPrice: '缓存写入5m',
      cacheWrite1hPrice: '缓存写入1h',
      cacheReadPrice: '缓存读取',
  ...
  webChat: {
    ...
    noDefault: '不设置',
    deleteProjectConfirm: '删除项目后，其会话将回到未分类。确认删除？',
    templates: '模板',
    templateLibrary: '提示词模板库',
    personalTemplates: '我的模板',
    systemTemplate: '系统模板',
    personalTemplate: '个人模板',
    newPersonalTemplate: '新建个人模板',
    category: '分类',
    language: '语言',
    templateBody: '模板正文',
    ...
    addVariable: '添加变量',
    preview: '最终内容预览',
    copyAsPersonal: '复制为个人模板',
    insertTemplate: '插入编辑器',
    chooseTemplate: '请选择一个模板',
    deleteTemplateConfirm: '确认删除这个个人模板？',
    versionOriginal: '原始',
    versionRegenerated: '重新生成',
    versionEdited: '编辑重发',
    newChat: '新建对话',
    noSessions: '暂无会话',
    searchSessions: '搜索标题、模型或分组',
    pin: '置顶/取消置顶',
    rename: '重命名',
    renamePrompt: '输入新的会话标题',
    deleteConfirm: '确定删除当前会话吗？此操作不可撤销。',
    ...
    emptyDescription: '选择分组和模型后直接发送，已有会话也可以在下次发送前切换目标模型。',
    selectGroup: '选择分组',
    group: '分组',
    model: '模型',
    context: '当前上下文',
  ...
  profile: {
    ...
    memberSince: '注册时间',
    basicsTitle: '基本资料',
    basicsDescription: '管理头像、用户名和账户基础信息',
    linkedProfileSources: '资料来源',
    linkedProfileSourcesDescription: '以下信息来自您当前已绑定的登录来源',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
    enterUsername: '输入用户名',
    ...
    avatar: {
      title: '头像',
      description: '上传并管理您的头像',
      uploadAction: '上传图片',
      uploadHint: '上传图片会尽量压缩到 20KB 以内',
      uploadRequired: '请先选择有效的头像图片',
      invalidType: '请选择图片文件',
      gifTooLarge: 'GIF 头像需先压缩到 20KB 以内',
      compressTooLarge: '无法将该图片压缩到 20KB 以内',
      compressFailed: '处理所选图片失败',
      readFailed: '读取所选图片失败',
      saveSuccess: '头像已更新',
      deleteSuccess: '头像已移除',
    ...
    authBindings: {
      title: '绑定登录方式',
      description: '管理当前账号可使用的登录方式',
      bindAction: '绑定 {providerName}',
      unbindAction: '解绑',
      bindSuccess: '绑定成功',
      unbindSuccess: '已解绑 {providerName}',
      boundCount: '已绑定 {count} 个身份',
      emailPlaceholder: '输入邮箱地址',
      codePlaceholder: '6位验证码',
      passwordPlaceholder: '设置登录密码',
      replaceEmailPasswordPlaceholder: '请输入当前密码',
    ...
    balanceNotify: {
      ...
      systemDefault: '系统默认值',
      extraEmails: '额外通知邮箱',
      extraEmailsHint: '最多可添加 3 个提醒邮箱，未验证邮箱需先完成验证',
      noExtraEmails: '暂无额外通知邮箱',
      enterEmail: '输入邮箱地址',
      addEmail: '添加邮箱',
      emailPlaceholder: '输入邮箱地址',
      emailDuplicate: '该邮箱已在提醒列表中',
      sendCode: '发送验证码',
      codeSent: '验证码已发送',
      codeSentTo: '验证码已发送到 {email}',
      enterCode: '输入验证码',
  ...
  admin: {
    ...
    dashboard: {
      ...
      quickActions: '快捷操作',
      batchImage: '批量生图',
      batchImageDesc: '进入批量图片任务',
      groupPricing: '分组定价',
      groupPricingDesc: '配置分组、额度和计费',
      manageUsers: '管理用户',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 subapis-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    users: {
      ...
      filterSettings: '筛选设置',
      columnSettings: '列设置',
      columnAlwaysVisible: '该列固定显示',
      sortBy: '排序字段',
      sortCurrentPageOnly: '仅对当前页排序',
      filterValue: '输入值',
      platformQuota: {
        title: '用户平台限额',
        subtitle: '为 {email} 设置各平台每日、每周、每月限额。',
        hint: '留空表示不限制。已用额度显示为每日 / 每周 / 每月窗口。',
        subscriptionWarning: '该用户存在有效订阅，请确认平台限额不会与订阅额度策略冲突。',
        columns: {
          platform: '平台',
          daily: '每日限额',
          weekly: '每周限额',
        ...
        cancel: '取消',
        clearAll: '清空全部限额',
        clearAllConfirm: '确定要清空该用户所有平台限额吗？',
        loadFailed: '加载平台限额失败',
        updateSuccess: '平台限额已保存',
        updateFailed: '保存平台限额失败',
        invalidNumber: '限额必须为空或大于等于 0',
        cellColumnTooltip: '查看或编辑该用户的平台限额',
        ...
        reset: {
          button: '重置已用额度',
          confirm: '确定要重置 {platform} 的 {window} 已用额度吗？',
          success: '已用额度已重置',
          failed: '重置已用额度失败'
        }
      },
    ...
    groups: {
      ...
      profitControl: {
        enable: '启用利润控制',
        enabledHint: '仅选择满足最低利润率和安全缓冲要求的账号。',
        disabledHint: '关闭后，账号选择不再校验利润率。',
        minMargin: '最低利润率',
        minMarginHint: '账号在计入上游成本和费率倍率后必须达到的最低利润率。',
        safetyBuffer: '安全缓冲',
        safetyBufferHint: '为上游价格波动预留的额外利润空间。',
        marginRangeError: '最低利润率必须在 0%（含）到 100%（不含）之间。',
        bufferRangeError: '安全缓冲必须在 0%（含）到 100%（不含）之间。',
        sumTooHigh: '最低利润率与安全缓冲之和必须小于 100%。'
      },
      subscription: {
        title: '订阅设置',
        type: '计费类型',
      ...
      compositeRoutes: {
        ...
        targetPlatform: '目标平台',
        upstreamModel: '上游模型',
        upstreamModelHint: '留空时透传原始请求模型；前缀匹配会分别透传每个命中的模型。填写后，所有命中请求都转发到这个固定模型。',
        notes: '备注',
        enabled: '启用',
        preview: '路由预览',
        matched: '已匹配',
        ...
        routeCreated: '组合路由已创建',
        routeUpdated: '组合路由已更新',
        routeDeleted: '组合路由已删除',
        failedToLoad: '加载组合路由失败',
        failedToSave: '保存组合路由失败',
        failedToDelete: '删除组合路由失败',
        failedToPreview: '预览组合路由失败',
      ...
      claudeMaxSimulation: {
        ...
        tooltip:
          '启用后，当 Claude 模型的上游用量没有 cache-write 时，系统会确定性地将 Token 映射为少量输入和 1 小时缓存创建，同时保持总 Token 不变。',
        enabled: '已启用（模拟 1 小时缓存）',
        disabled: '已禁用',
        hint: '仅调整用量账单日志中的 Token 分类，不会持久化单次请求映射状态。'
      },
      supportedScopes: {
        title: '支持的模型系列',
    ...
    channels: {
      ...
      intervalValidation: {
        ...
        price: {
          ...
          cacheWrite5mPrice: '缓存写入5m价格',
          cacheWrite1hPrice: '缓存写入1h价格',
      ...
      form: {
        ...
        pricingEnabled: '已启用',
        pricingDisabled: '已关闭',
        pricingDisabledHint: '此定价已关闭：保留模型和价格，但不会作为可用模型、限制允许项或渠道计费规则生效。',
        noModels: '未添加模型',
        applyPricingToAccountStats: '将请求定价应用到账号统计',
        applyPricingToAccountStatsHint: '仅影响后台账号成本统计，用户计费和余额扣减保持不变。',
        ...
        matchGroups: '匹配分组',
        matchAccountIds: '匹配账号 ID',
        matchAccountIdsPlaceholder: '用逗号或换行分隔账号 ID',
        pricing: '定价'
      }
    },
    ...
    riskControl: {
      ...
      preBlockSyncHint: '展示同步前置拦截的实时命中和处理情况。',
      ...
      keywordModeKeywordOnlyDesc: '只使用本地关键词规则，不调用审核 API。',
      keywordModeApiOnly: '仅 API 审核',
      keywordModeApiOnlyDesc: '跳过本地关键词规则，只调用审核 API。',
      modelFilterAll: '全部模型',
      modelFilterAllDesc: '所有模型请求都会进入审核流程。',
      modelFilterInclude: '仅指定模型',
      modelFilterIncludeDesc: '只有指定模型会进入审核流程。',
      modelFilterExclude: '排除指定模型',
      modelFilterExcludeDesc: '除指定模型外的请求都会进入审核流程。',
      modelFilter: '模型筛选',
      modelFilterHint: '限制哪些模型请求进入内容审计流程。',
      modelFilterModels: '模型列表',
      modelFilterModelsRequired: '请选择至少一个模型',
      modelFilterAllSummary: '全部模型',
      modelFilterIncludeSummary: '仅审核 {count} 个模型',
      modelFilterExcludeSummary: '排除 {count} 个模型',
      modelFilterModelCount: '{count} 个模型',
      keywordBlockingMode: '关键词拦截模式',
      keywordModeApiOnlyNotice: '当前仅调用 API 审核，本地关键词不会参与拦截。',
      keywordModeKeywordOnlyNotice: '当前仅使用本地关键词规则，不会调用审核 API。',
      blockedKeywords: '拦截关键词',
      blockedKeywordCount: '{count} 个关键词',
      blockedKeywordsDescription: '命中这些关键词的请求会按当前策略处理。',
      blockedKeywordsPlaceholder: '每行一个关键词',
      blockedKeywordsPreBlockHint: '前置拦截会优先检查这些关键词。',
      blockedKeywordsModeWarning: '当前模式：{mode}',
      blockedKeywordsLimit: '最多 {max} 个关键词',
      riskThresholds: '风险阈值',
      riskThresholdsHint: '配置各分类的命中阈值。',
      riskThresholdReset: '恢复默认阈值',
      riskThresholdPercent: '阈值百分比',
      riskThresholdDefault: '默认 {value}',
      preBlockActive: '前置拦截',
      preBlockActiveHint: '当前前置拦截是否启用。',
      preBlockChecked: '已检查',
      preBlockCheckedHint: '进入前置拦截检查的请求数。',
      preBlockAllowed: '已放行',
      preBlockAllowedHint: '前置拦截检查后允许继续的请求数。',
      preBlockBlocked: '已拦截',
      preBlockBlockedHint: '被前置拦截直接阻断的请求数。',
      preBlockErrors: '异常',
      preBlockErrorsHint: '前置拦截检查过程中的异常数。',
      preBlockAvgLatency: '平均延迟',
      preBlockAvgLatencyHint: '前置拦截检查的平均耗时。',
      overview: {
        status: '运行状态',
        enabled: '已启用',
        disabled: '未启用',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeChatCompletionsHint: '使用 /v1/chat/completions 请求格式。',
        apiModeResponses: 'Responses',
        apiModeResponsesHint: '使用 /v1/responses 请求格式。',
        kindRequired: '请选择供应商'
      },
      runResultTitle: '检测结果',
      noMonitorsYet: '暂无监控',
    ...
    subscriptions: {
      ...
      quotaEndsInMinutes: '{minutes} 分钟后结束',
      quotaEndsInHoursMinutes: '{hours} 小时 {minutes} 分钟后结束',
      quotaEndsInDaysHours: '{days} 天 {hours} 小时后结束',
      daysRemaining: '天剩余',
      ...
      resetQuotaTarget: '订阅用户:',
      resetQuotaSelectLabel: '选择要重置的统计窗口:',
      resetQuotaDaily: '每日用量(daily_usage_usd 归零)',
      resetQuotaWeekly: '每周用量(weekly_usage_usd 归零)',
      resetQuotaMonthly: '每月用量(monthly_usage_usd 归零)',
      resetQuotaHint: '仅清零并重启被勾选的统计窗口,其它窗口不受影响。例如只勾"每周"时,月度累计额度不变。',
    ...
    accounts: {
      ...
      dataImportParseFailedFile: '文件解析失败：{name}',
      dataImportInvalidFile: '无效的数据文件：{name}',
      ...
      testAccount: '测试账号',
      searchAccounts: '搜索账号...',
      searchAvailabilityModel: '按模型筛选可用性，支持模糊搜索，例如 opus 或 claude-sonnet-4-6',
      notes: '备注',
      ...
      status: {
        ...
        overageExhausted: '超额已用尽',
        overageExhaustedUntil: '超额额度已用尽，预计 {time} 恢复',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokWeeklyCredits: '周额',
        grokRequestsRate: 'Req',
        grokTokensRate: 'Tok',
        grokWeeklySummary: '周额度已用 {used}，剩余 {remaining}',
        grokOnDemandSummary: '按量付费已用 {used}/{cap}，剩余 {remaining}',
        grokOnDemandDisabled: '按量付费未开启',
        grokPrepaidBalance: '预付余额 {balance}',
        grokBillingUnknown: '尚未查询官方 Grok Billing 额度。',
        grokBillingFailed: '官方 Grok Billing 额度查询失败。',
        grokBillingUpdated: '额度 {time}',
        grokUnknown: 'Grok 速率限制需等待上游响应头后显示。',
        grokRetryAfter: '{time} 后重试',
        grokProbe: '刷新额度',
        grokProbeTooltip: '查询 Grok CLI 官方 Billing 接口，不发送推理请求',
      ...
      openaiQuotaReset: {
        ...
        refreshCachePersistFailed: '额度已刷新，但刷新后的缓存保存失败。',
        resetCacheRefreshFailed: '重置成功，但未能读取刷新后的额度。',
        resetAccountRecoveryFailed: '重置成功，但恢复账号状态失败。',
        resetAccountRefreshFailed: '重置成功，但刷新账号状态失败。',
        confirmTitle: '确认重置周限',
      ...
      bulkActions: {
        ...
        selectedAll: '已全选 {count} 个账号',
        selectingAll: '正在全选账号...',
        selectAllResults: '全选全部 {count} 条结果',
        selectAllFailed: '全选账号失败',
      ...
      bulkEdit: {
        ...
        rateSyncWarning: '费率同步仅适用于支持的账号类型。',
        rateSyncConflict: '费率同步与所选的 {count} 个账号冲突。'
      },
      ...
      openai: {
        ...
        flattenNamespacesDesc: '默认关闭：/responses 上的 namespace 工具声明原样转发。仅当该 OAuth 账号指向不支持 namespace 工具的兼容上游时才开启；摊平会将工具重命名为 namespace__tool。',
      ...
      anthropic: {
        ...
        oauthNativePassthroughDesc:
          '仅对 Anthropic OAuth/SetupToken 的 Claude Code 请求生效。正常消息、compaction 等官方请求仅替换认证，并保留原始请求体、允许的客户端请求头和响应格式；连接探测仍由网关本地响应，非 Claude Code 请求继续使用兼容逻辑。默认关闭。',
      ...
      syncUpstreamModels: '从上游同步模型',
      syncUpstreamModelsLoading: '同步中...',
      syncUpstreamModelsEmpty: '上游未返回可同步模型',
      syncUpstreamModelsFailed: '同步上游模型失败',
      syncUpstreamModelsSuccess: '已从上游同步 {count} 个新模型（共 {total} 个）',
      syncUpstreamModelsNoChanges: '没有新模型，{count} 个上游模型已存在',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 SubAPIs 实例的场景。',
      poolModeRetryCount: '同账号重试次数',
      poolModeRetryCountHint: '仅在池模式下生效。0 表示不原地重试；默认 {default}，最大 {max}。',
      poolModeRetryStatusCodes: '重试 HTTP 状态码',
      poolModeRetryStatusCodesHint: '池模式下需要重试的上游 HTTP 状态码，英文逗号分隔。默认：{default}。',
      headerOverride: {
        title: '请求头覆写',
        hint: '为支持的 API Key 账号批量配置自定义上游请求头。',
        info: '覆写请求头会在过滤禁止项后发送给上游，请谨慎使用。',
        bulkReplaceHint: '保存后将替换所有选中账号的请求头覆写配置。',
        bulkDisableHint: '关闭开关可为所选账号禁用请求头覆写。',
        namePlaceholder: '请求头名称',
        valuePlaceholder: '请求头值',
        addRow: '添加请求头',
        fillTemplate: '填充模板',
        emptyValueHint: '允许空值，会作为空请求头发送。',
        bulkEmptyRows: '请至少添加一行请求头，或关闭请求头覆写以清空配置。',
        invalidName: '请求头名称无效。',
        blockedName: '该请求头不允许覆写。',
      ...
      oauth: {
        ...
        kiro: {
          ...
          oauthProviderTitle: '登录提供方',
          socialSubtitle: '按 Kiro 页面实际展示选择',
          googleTitle: 'Google',
          googleDesc: '使用 Google 登录',
          githubTitle: 'GitHub',
          githubDesc: '使用 GitHub 登录',
      ...
      testCompleted: '测试完成！',
      requestStarted: '已开始发起测试请求',
      connectedToApi: '已开始发起测试请求',
      usingModel: '使用模型：{model}',
      sendingTestMessage: '发送测试消息："hi"',
      sendingMinimalProbeRequest: '发送最小探测请求："."（max_tokens=1）',
    ...
    redeem: {
      ...
      failedToBatchUpdate: '批量更新失败',
      selectCodesFirst: '请先选择兑换码',
      clearSelection: '清除选择',
      selectedCount: '已选择 {count} 个',
      codeExpiry: '兑换码过期时间',
      expiryDaysRequired: '请输入有效的过期天数',
      noBatchFieldsSelected: '请至少选择一个要批量更新的字段',
      batchNotesPlaceholder: '输入备注，留空可清空备注',
      batchFields: {
        status: '状态',
        expiresAt: '过期时间',
        notes: '备注',
    ...
    announcements: {
      ...
      form: {
        ...
        targetingCustom: '按条件',
        addOrGroup: '添加任一条件组',
        addAndCondition: '添加同时满足条件',
        orGroupLabel: '任一条件组',
        andConditionLabel: '同时满足',
        conditionType: '条件类型',
    ...
    usage: {
      ...
      allModels: '全部模型',
      allUpstreamModelAudit: '全部上游模型审计结果',
      upstreamModelAudit: '上游模型审计',
      upstreamModelMismatchOnly: '仅模型不一致',
      upstreamModelMatchedOnly: '仅模型一致',
      allAccounts: '全部账户',
      allGroups: '全部分组',
      allTypes: '全部类型',
      inputCost: '输入成本',
    ...
    ops: {
      ...
      settings: {
        ...
        autoRefreshCountdown: '自动刷新：{seconds}s',
        openaiQuotaAutoPause: 'OpenAI 账号额度自动暂停',
        openaiQuotaAutoPauseHint: '当账号 5h 或 7d 额度使用达到阈值时，自动暂停该账号调度。',
        openaiQuotaAutoPauseDefault5h: '默认 5h 阈值（%）',
        openaiQuotaAutoPauseDefault7d: '默认 7d 阈值（%）',
        openaiQuotaAutoPauseThresholdHint: '留空或 0 表示不启用该窗口的自动暂停。',
        validation: {
          title: '请先修正以下问题',
          ...
          openaiQuotaAutoPauseRange: 'OpenAI 账号额度自动暂停阈值必须在 0-100% 之间'
        }
      },
      concurrency: {
        title: '并发 / 排队',
    ...
    settings: {
      ...
      apiKeyUsage: {
        title: 'API 密钥使用配置',
        description: '统一管理用户“使用密钥”弹窗中的内置客户端配置和按分组匹配的自定义模板。该配置会公开下发，请勿填写密钥等敏感信息。',
        ...
        groupTemplates: {
          title: '分组固定模板',
          description: '为指定分组保存固定配置，并通过模板开关决定“使用密钥”中显示哪些客户端。启用后，该分组只显示这里开启的模板。',
          selectGroup: '选择分组',
          addGroup: '添加分组配置',
          empty: '尚未配置分组固定模板，所有分组继续使用内置配置。',
          overrideEnabled: '已接管该分组的“使用密钥”显示',
          overrideDisabled: '已停用，继续使用内置配置',
          templates: '显示模板',
          templatesHint: '开启的模板会按 sort_order 排序显示。',
          addTemplate: '新增固定模板',
          noTemplates: '没有模板。启用此分组配置时，用户端将不显示任何客户端配置。',
          editTemplate: '编辑模板内容',
          templateJson: '固定模板 JSON',
          variables: '模板内容支持 api_key、base_url、base_url_v1、base_url_v1beta、group_id、group_name、platform 等双花括号变量。',
          newTemplate: '新固定模板',
          defaultVariant: '配置',
          objectRequired: '模板 JSON 顶层必须是对象',
          fieldsRequired: '模板必须包含 id、label、kind 和 variants'
        },
        templateProfiles: {
          title: '高级客户端模板规则',
          description: '用于跨平台、多分组和优先级组合；普通分组配置请优先使用上方固定模板。',
          addProfile: '新增规则',
          empty: '尚未配置自定义规则，用户端继续使用内置模板。',
          newProfile: '新模板规则',
          profileId: '规则 ID',
          profileName: '规则名称',
          mode: '应用模式',
          priority: '优先级',
          platforms: '匹配平台',
          platformsPlaceholder: '例如：grok, anthropic；留空匹配全部',
          groups: '匹配分组（可多选）',
          matchHint: '平台与分组同时填写时必须同时匹配；分组留空表示不限制 Group ID。',
          presets: '追加预设：',
          templatesJson: '模板 JSON',
          variables: '可用变量：api_key、base_url、base_url_v1、base_url_v1beta、group_id、group_name、platform（JSON 中使用双花括号包裹）以及 Claude/Codex/Gemini 模型配置变量。claude_code_only 分组最终只展示 kind=claude_code 的模板。',
          arrayRequired: '模板 JSON 顶层必须是数组'
        },
        saved: 'API 密钥使用配置已保存',
      ...
      features: {
        ...
        webChat: {
          ...
          projects: '启用项目空间',
          projectsHint: '允许用户按项目归档会话并设置默认模型和模板。',
          templates: '启用提示词模板',
          templatesHint: '开放系统模板和个人模板库，支持结构化变量。',
          history: '启用消息版本历史',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth 登录及企业身份同步。',
        enable: '启用钉钉登录',
        enableHint: '允许用户使用钉钉账号登录。',
        clientId: 'Client ID / AppKey',
        clientIdPlaceholder: '输入钉钉 Client ID 或 AppKey',
        clientIdHint: '来自钉钉开发者后台应用凭证。',
        clientSecret: 'Client Secret / AppSecret',
        clientSecretPlaceholder: '输入钉钉 Client Secret 或 AppSecret',
        clientSecretConfiguredPlaceholder: '已配置，留空保持不变',
        clientSecretHint: '将加密保存，用于钉钉 OAuth 回调。',
        clientSecretConfiguredHint: 'Client Secret 已配置，留空保持当前值。',
        redirectUrl: '回调地址',
        redirectUrlPlaceholder: 'https://example.com/auth/dingtalk/callback',
        redirectUrlHint: '必须与钉钉应用中配置的回调地址一致。',
        corpPolicy: {
          label: '企业限制策略',
          hint: '按需限制只有钉钉企业内部成员可以登录。',
          none: '不限制',
          internalOnly: '仅企业内部成员'
        },
        bypassRegistration: '绕过注册限制',
        bypassRegistrationHint: '允许企业内部钉钉用户在普通注册限制开启时仍可创建或绑定账号。',
        syncDisplayName: '同步显示名称',
        syncDisplayNameHint: '登录后将钉钉姓名写入用户属性。',
        syncDisplayNameTarget: '属性 Key',
        syncAttrDisplayName: '显示名称',
        syncDisplayNameTargetHint: '同步值会按该 Key 和显示名称保存到用户属性。',
        syncCorpEmail: '同步企业邮箱',
        syncCorpEmailHint: '登录后将钉钉企业邮箱写入用户属性。',
        syncCorpEmailPermissionHint: '需要钉钉应用具备读取企业邮箱的权限。',
        syncCorpEmailTarget: '属性 Key',
        syncCorpEmailTargetHint: '同步的企业邮箱会按该 Key 和显示名称保存到用户属性。',
        syncDept: '同步部门',
        syncDeptHint: '登录后将钉钉部门写入用户属性。',
        syncDeptPermissionHint: '需要钉钉应用具备读取部门信息的权限。',
        syncDeptTarget: '属性 Key',
        syncDeptTargetHint: '同步的部门会按该 Key 和显示名称保存到用户属性。'
      },
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 SubAPIs 用户登录',
      ...
      defaults: {
        ...
        defaultPlatformQuotasHint: '为新用户设置各平台的默认每日、每周、每月消费限额。',
        platformQuotaNotice: '留空表示不限制；这些默认值只会在新用户创建时写入。'
      },
      claudeCode: {
      ...
      gatewayForwarding: {
        ...
        clientDatelineNormalizationHint:
          '默认开启。将 Anthropic OAuth/Setup Token 请求体中 "Today\'s date is …" 语句里的撇号与日期分隔符还原为 ASCII 撇号 + 短横线 (2026-07-01) 的规范形态，抹除某些客户端在检测到非官方 base URL 时注入的隐写指纹位。仅作用于 system prompt 与 <system-reminder> 块内，API Key 账号不受影响。',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '将额外的本地支付方式映射到易支付上游方式。',
        addCustomMethod: '添加方式',
        customMethodType: '本地类型',
        customMethodUpstreamType: '上游类型',
        customMethodDisplayName: '显示名称',
        validationEasyPayCustomMethodRequired: '自定义方式的本地类型和上游类型不能为空。',
        validationEasyPayCustomMethodTypeInvalid: '本地类型只能包含小写字母、数字、下划线和连字符。',
        validationEasyPayCustomMethodUpstreamTypeInvalid: '上游类型只能包含小写字母、数字、下划线和连字符。',
        validationEasyPayCustomMethodReserved: '该方式类型已是易支付内置类型。',
        validationEasyPayCustomMethodPrefixReserved: '自定义方式类型不能以 alipay 或 wxpay 开头。',
        validationEasyPayCustomMethodDuplicate: '自定义方式类型不能重复。',
        noProviders: '暂无服务商实例',
      ...
      emailTemplates: {
        ...
        empty: '请选择一个邮件事件',
        subject: '邮件标题',
        subjectPlaceholder: '输入邮件标题',
        html: 'HTML 内容',
        htmlPlaceholder: '输入 HTML 邮件内容',
        placeholders: '可用变量',
        placeholdersHelp: '点击变量可复制到剪贴板。',
        livePreview: '实时预览',
        noPreview: '暂无预览',
        customized: '已自定义',
        previewSecurityHint: '预览仅用于检查布局，实际发送仍由后端模板渲染。',
        validationRequired: '邮件标题和 HTML 内容不能为空',
        saveSuccess: '邮件模板已保存',
        restoreConfirm: '确定要恢复官方模板吗？当前自定义内容会被覆盖。',
      ...
      authSourceDefaults: {
        ...
        platformQuotasOverride: '覆盖平台限额',
        platformQuotasOverrideHint: '为此注册来源覆盖系统默认平台限额；留空表示沿用系统默认。',
        sources: {
          email: {
            title: '邮箱注册',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 SubAPIs',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SubAPIs 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 SubAPIs 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 SubAPIs',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 SubAPIs AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    invoice: {
      apply: '申请发票',
      submit: '提交并自动开票',
      submitted: '发票申请已提交，系统正在自动开票',
      autoIssueHint: '请选择已完成且未开票的订单，系统会按实际支付金额合并开票，不能手动修改开票金额。',
      selectOrders: '选择开票订单',
      totalAmount: '开票合计',
      ...
      enterprise: '企业',
      buyerName: '发票抬头/个人姓名',
      buyerNamePlaceholder: '个人请填写姓名或称谓，企业请填写公司名称',
      buyerTaxNo: '纳税人识别号',
      buyerEmail: '接收邮箱',
      buyerPhone: '接收手机号',
      buyerAddress: '购买方地址',
    ...
    admin: {
      ...
      originalPrice: '原价',
      price: '价格',
      subscriptionCnyPayPreview: '预计订阅支付：{amount}',
      subscriptionCnyPayPreviewWithFee: '（手续费 {feeRate}%，实付 {total}）',
      validityDays: '有效期（天）',
      validityUnit: '有效期单位',
      sortOrder: '排序',
      forSale: '上架状态',
      ...
      unlimited: '无限制',
      invoiceConfig: '发票配置',
      invoiceConfigHint: '开启后，用户可在订单页选择已完成且未开票订单合并申请发票；提交后会按第三方配置自动开票。',
      invoiceEnabled: '启用发票申请',
      invoiceEnabledHint: '控制用户端订单页是否展示申请发票入口',
      invoiceAutoIssue: '自动开票',
      invoiceAutoIssueHint: '用户提交后立即调用开票服务，不进入人工审核',
      invoiceProvider: '开票服务商',
      invoiceProviderUnset: '未配置',
      invoiceProviderMock: '模拟服务商',
      invoiceProviderLexiang: '乐享全票种',
      defaultInvoiceType: '默认发票类型',
      invoiceTypeDigitalNormal: '数电普票',
      invoiceTypeDigitalSpecial: '数电专票',
      invoiceTaxRate: '税率',
      invoiceItemName: '商品/服务名称',
      invoiceTaxClassificationCode: '税收分类编码',
      invoiceSellerInfo: '销方信息',
      sellerName: '销方名称',
      sellerTaxNo: '销方税号',
      sellerAddress: '销方地址',
      sellerPhone: '销方电话',
  ...
  adminStatus: {
    title: '服务状态探测',
    description: '配置模型端点的自动探测，用于监控服务状态页面的可用性与延迟。',
    enabled: '启用探测',
    enabledHint: '启用后，系统将定期探测已配置的模型端点。',
    publicVisible: '对用户展示',
    publicVisibleHint: '关闭后，探测和外部监控仍会运行，但普通用户不再看到服务状态页面与入口。',
    interval: '探测间隔（分钟）',
    retention: '数据保留（天）',
    baseUrl: '网关基础地址',
    baseUrlPlaceholder: 'https://your-domain.com',
    baseUrlHint: '用于探测请求的网关 API 基础地址，例如 https://your-domain.com',
    apiKey: 'API 密钥',
    apiKeyPlaceholder: '输入 API 密钥',
    apiKeyHint: '用于探测请求的 API 密钥，必须有权限访问所配置模型。留空会保留已有密钥。',
    models: '监控模型',
    modelsHint: '每个模型可独立配置基础地址和密钥，保存后调度器会按间隔执行探测。',
    modelId: '模型 ID',
    displayName: '显示名称',
    sortOrder: '排序',
    modelEnabled: '启用',
    ...
    deleteModel: '删除模型',
    unnamedModel: '未命名模型',
    noModels: '暂无监控模型，请添加至少一个模型。',
    viewStatusPage: '查看服务状态页面',
    save: '保存服务状态配置',
    saved: '服务状态配置已保存',
