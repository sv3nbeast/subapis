export default {
    ...
    groups: {
      ...
      modelPricing: {
        title: '模型定价',
        description: '配置此分组按模型区分的 Token 和图片价格。',
        add: '添加定价规则',
        longContext: '长上下文定价',
        longContextHint: '为超过长上下文阈值的请求配置单独价格。'
      },
      form: {
        name: '名称',
        description: '描述',
        ...
        maxReasoningEffortHint: '仅限制客户端主动请求的 Anthropic/OpenAI 推理强度；Composite 分组按实际目标平台生效。超过上限时自动降档，不会为缺省请求主动开启推理。上限优先级高于推理强度映射。',
