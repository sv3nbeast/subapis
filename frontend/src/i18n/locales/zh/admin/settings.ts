export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        kiroOperatorInstructionsEnabled: 'Kiro 运营附加指令',
        kiroOperatorInstructionsEnabledHint: '在 Kiro 渠道 Claude 模型的平台前导中追加一段运营指令。仅作用于 Kiro 账号；GPT 与 Sonnet 系模型保留原有提示，不注入此段。默认开启。',
        kiroOperatorInstructions: 'Kiro 运营附加指令内容',
        kiroOperatorInstructionsPlaceholder: '留空时使用内置默认文本（Verify before asserting…）。',
        kiroOperatorInstructionsHint: '保存后最多 60 秒内生效。上限 4000 字符。改动文本前建议先用真实上游做身份与任务 A/B。',
        systemBlockTitle: '系统块 {index}',
