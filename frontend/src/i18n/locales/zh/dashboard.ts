export default {
  ...
  usage: {
    ...
    longContextBilling: '长上下文计价',
    longContextBillingApplied: '已触发长上下文计价',
    longContextBillingBadge: '长上下文',
    longContextBillingHint: '本次请求的输入上下文超过长上下文阈值，整次请求按长上下文档计费：输入 ×{input}、输出 ×{output}。',
    longContextBillingContext: '本次上下文 Token',
    ...
    exportTooLarge: '导出数据量超过上限（{limit} 条），请缩小时间范围或筛选条件',
    exportInProgress: '已有导出任务正在进行，请等待其完成后再试',
    exportRateLimited: '请求过于频繁，请稍后再试',
