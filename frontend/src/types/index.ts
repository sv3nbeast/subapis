...
export interface Group {
  ...
  allow_non_stream_messages?: boolean
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kiro' | 'droid' | 'grok' | 'cursor' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go'
