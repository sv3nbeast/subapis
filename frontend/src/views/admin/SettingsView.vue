                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full text-sm">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in CONCRETE_PLATFORM_VALUES" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      ...
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in CONCRETE_PLATFORM_VALUES" :key="`${authSource.source}-pq-${p}`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p }}</span>
                              </td>
                              <td class="pr-4 py-1">
            ...
            <div class="space-y-5 p-6">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  >
                    {{
                      t(
                        "admin.settings.gatewayForwarding.kiroOperatorInstructionsEnabled",
                      )
                    }}
                  </label>
                  <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                      t(
                        "admin.settings.gatewayForwarding.kiroOperatorInstructionsEnabledHint",
                      )
                    }}
                  </p>
                </div>
                <Toggle v-model="form.enable_kiro_operator_instructions" />
              </div>
              ...
              <div>
                ...
                >
                  {{
                    t(
                      "admin.settings.gatewayForwarding.kiroOperatorInstructions",
                    )
                  }}
                </label>
                <textarea
                  v-model="form.kiro_operator_instructions"
                  rows="5"
                  class="input w-full resize-y font-mono text-xs leading-5"
                  :placeholder="
                    t(
                      'admin.settings.gatewayForwarding.kiroOperatorInstructionsPlaceholder',
                    )
                  "
                  :disabled="!form.enable_kiro_operator_instructions"
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{
                    t(
                      "admin.settings.gatewayForwarding.kiroOperatorInstructionsHint",
                    )
                  }}
                </p>
              </div>
...
const form = reactive<SettingsForm>({
  ...
  // Legacy API field; direct Anthropic OAuth CCH signing is automatic.
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      enable_kiro_operator_instructions: form.enable_kiro_operator_instructions,
      kiro_operator_instructions: form.kiro_operator_instructions?.trim()
        ? form.kiro_operator_instructions.trim()
        : "",
