<template>
  <AppLayout>
    <TablePageLayout class="keys-table-layout">
      <template #filters>
      ...
      <template #actions>
        <div class="keys-page-actions flex justify-end gap-3">
          <div class="ui-v2-standard-page-heading">
